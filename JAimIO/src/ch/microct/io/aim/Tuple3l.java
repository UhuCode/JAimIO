 ...
 * @since vecmath 1.2
 */
public abstract class Tuple3l implements java.io.Serializable, Cloneable {
    ...
    /**
     * Constructs and initializes a Tuple3l from the specified
     * x, y, and z coordinates.
     * @param x the x coordinate
     * @param y the y coordinate
     * @param z the z coordinate
     */
    public Tuple3l(int x, int y, int z) {
	this.x = x;
	this.y = y;
	this.z = z;
    }
     ...
     * @param z the z coordinate
     */
    public Tuple3l(long x, long y, long z) {
	this.x = x;
	this.y = y;
	this.z = z;
    }
     ...
     * @param z the z coordinate
     */
    public final void set(long x, long y, long z) {
	this.x = x;
	this.y = y;
	this.z = z;
    }
     ...
     */
    public final void set(Tuple3l t1) {
	this.x = t1.x;
	this.y = t1.y;
	this.z = t1.z;
    }
     ...
     */
    public final void get(Tuple3l t) {
	t.x = this.x;
	t.y = this.y;
	t.z = this.z;
    }
     ...
     */
    public final void add(Tuple3l t1, Tuple3l t2) {
	this.x = t1.x + t2.x;
	this.y = t1.y + t2.y;
	this.z = t1.z + t2.z;
    }
     ...
     */
    public final void add(Tuple3l t1) {
	this.x += t1.x;
	this.y += t1.y;
	this.z += t1.z;
    }
     ...
     * @param t2 the second tuple
     */
    public final void sub(Tuple3l t1, Tuple3l t2) {
	this.x = t1.x - t2.x;
	this.y = t1.y - t2.y;
	this.z = t1.z - t2.z;
    }
     ...
     * @param t1 the other tuple
     */
    public final void sub(Tuple3l t1) {
	this.x -= t1.x;
	this.y -= t1.y;
	this.z -= t1.z;
    }
     ...
     */
    public final void negate(Tuple3l t1) {
	this.x = -t1.x;
	this.y = -t1.y;
	this.z = -t1.z;
    }
     ...
     * @param t1 the source tuple
     */
    public final void scale(int s, Tuple3l t1) {
	this.x = s*t1.x;
	this.y = s*t1.y;
	this.z = s*t1.z;
    }
     ...
     */
    public final void scaleAdd(int s, Tuple3l t1, Tuple3l t2) {
	this.x = s*t1.x + t2.x;
	this.y = s*t1.y + t2.y;
	this.z = s*t1.z + t2.z;
    }
     ...
     */
    public final void scaleAdd(long s, Tuple3l t1) {
     ...
     */
    public final void clamp(long min, long max, Tuple3l t) {
        if( t.x > max ) {
	    x = max;
        } else if( t.x < min ) {
	    x = min;
     ...
     *  @param t   the source tuple, which will not be modified
     */
    public final void clampMin(long min, Tuple3l t) {
        if( t.x < min ) {
	    x = min;
        } else {
	    x = t.x;
     ...
     *  @param t   the source tuple, which will not be modified
     */
    public final void clampMax(long max, Tuple3l t) {
        if( t.x > max ) {
	    x = max;
        } else {
	    x = t.x;
     ...
     *  @param t   the source tuple, which will not be modified
     */
    public final void absolute(Tuple3l t) {
	x = Math.abs(t.x);
	y = Math.abs(t.y);
	z = Math.abs(t.z);
    }
     ...
     */
    public final void clamp(long min, long max) {
	if( x > max ) {
	    x = max;
        } else if( x < min ) {
	    x = min;
     ...
     *  @param min   the lowest value in this tuple after clamping
     */
    public final void clampMin(long min) {
	if (x < min)
	    x=min;
     ...
     *  @param max   the highest value in the tuple after clamping
     */
    public final void clampMax(long max) {
	if (x > max)
	    x = max;
